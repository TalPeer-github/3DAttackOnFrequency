...
class RnnWalkNet(RnnWalkBase):
    def __init__(self,
        ...
        if params.layer_sizes is None:
            self._layer_sizes = {'fc1': 64, 'fc2': 128, 'fc3': 256, 'gru1': 1024, 'gru2': 1024, 'gru3': 512, 'fc4': 512,
                                 'fc5': 128}
        else:
    ...
    def _init_layers(self):
        ...
        self._fc2 = layers.Dense(self._layer_sizes['fc2'], kernel_regularizer=kernel_regularizer,
                                 bias_regularizer=kernel_regularizer,
                                 kernel_initializer=initializer)
        self._fc3 = layers.Dense(self._layer_sizes['fc3'], kernel_regularizer=kernel_regularizer,
                                 bias_regularizer=kernel_regularizer,
                                 kernel_initializer=initializer)
        self._fc4 = layers.Dense(self._layer_sizes['fc4'], kernel_regularizer=kernel_regularizer,
                                 bias_regularizer=kernel_regularizer,
                                 kernel_initializer=initializer)
        ...
        self._gru3 = rnn_layer(self._layer_sizes['gru3'], time_major=False,
                               ...
                               kernel_regularizer=kernel_regularizer, recurrent_regularizer=kernel_regularizer,
                               bias_regularizer=kernel_regularizer)
        self._fc_last = layers.Dense(self._classes, kernel_regularizer=kernel_regularizer,
                                     bias_regularizer=kernel_regularizer,
...
def show_model():
    ...
    if 1:
        params = EasyDict({'n_classes': 3, 'net_input_dim': 3, 'batch_size': 32, 'last_layer_activation': 'softmax',
                           'one_label_per_model': True, 'logdir': '.', 'layer_sizes': None,
